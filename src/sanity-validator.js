...
const BOUNDS = [
  ...
  ['Fed Reserves ($T)',     d => d.fed?.reserves?.totalTrillions,                2.5,   5,      'desimal hilang? unit mismatch'],
  ['Fed Balance ($T)',      d => d.fed?.walcl?.totalTrillions,                   6,     9,      'unit'],
  ['Perp Sentiment Proxy',  d => d.daily?.optionsSkew?.skewProxy,                -10,   30,     'formula multiplier — non-normalized output'],
